...
public abstract class TFIDFSimilarity extends Similarity {
    ...
    protected class TFIDFSimScorer extends SimScorer {
        protected   IDFStats stats;
        protected   float weightValue;
        protected   NumericDocValues norms;
    ...
    protected static class IDFStats extends SimWeight {
    ...
    protected Explanation explainScore(int doc, Explanation freq, IDFStats stats, NumericDocValues norms) {
